...
use App\Service\ContactFormJson;
...
class ContactFormController extends AbstractController
{
    ...
    public function new(Request $request, ContactFormRepository $contactFormRepository, SerializerInterface $serializer, ContactFormJson $contactFormJson ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $path = Path::normalize($this->getParameter('kernel.project_dir') . $this->getParameter('contact.form.json.directory'));
            $contactFormJson->serializeToJsonFile($serializer, $contactForm, $path);
